...
import { 
  ...
  User, CreditCard, ChevronLeft, ChevronRight, Tractor, AlertTriangle 
} from 'lucide-react';
import { 
  validateEmail, 
  validatePhone, 
...
export default function FournisseurForm({ type, initialData, onBack, onNext }: Props) {
  ...
  const isEmailContactValid = formData.emailContact ? validateEmail(formData.emailContact) : true;
  const isContactExploitationValid = formData.contactExploitation ? validatePhone(formData.contactExploitation) : true;
  const isTelephoneResponsableValid = formData.telephoneResponsable ? validatePhone(formData.telephoneResponsable) : true;
  const isNifValid = formData.nif ? validateNif(formData.nif) : true;
  const isCinResponsableValid = formData.cinResponsable ? validateCin(formData.cinResponsable) : true;
  const isStatValid = formData.stat ? validateStat(formData.stat) : true;

  const isTelephoneParticulierValid = formData.telephoneParticulier ? validatePhone(formData.telephoneParticulier) : true;
  const isCinParticulierValid = formData.cinParticulier ? validateCin(formData.cinParticulier) : true;
    ...
    <div className="w-full max-w-4xl mx-auto p-2 space-y-4 h-fit animate-in fade-in duration-500">
      ...
      <div className="bg-white rounded-[20px] shadow-sm border border-separator/10 p-6 md:p-8 space-y-6">
        ...
        <div className="text-center space-y-1">
          <h2 className="text-xl font-bold text-label uppercase tracking-wider font-manrope">Information supplémentaire</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-6 animate-in slide-in-from-bottom-2 duration-300">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-3">
                  ...
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Nom de l'entité</label>
                    <div className="relative flex items-center">
                      <Building2 className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18} />
                      <Input 
                        type="text" 
                  ...
                  {/* Localisation Entité */}
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Localisation</label>
                    <div className="relative flex items-center">
                      <MapPin className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18} />
                      <Input 
                        type="text" 
                  ...
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Contact exploitation</label>
                    <div className="relative flex items-center">
                      <Phone className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18} />
                      <Input 
                        type="text" 
                        ...
                        onChange={(e) => handleInputChange('contactExploitation', formatPhone(e.target.value))}
                        required 
                      />
                    </div>
                  ...
                  {/* Email Contact */}
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">E-mail contact</label>
                    <div className="relative flex items-center">
                      <Mail className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18} />
                      <Input 
                        type="email" 
                  ...
                  {/* NIF */}
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">NIF</label>
                    <div className="relative flex items-center">
                      <FileText className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18} />
                      <Input 
                        type="text" 
                  ...
                  {/* STAT */}
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">STAT</label>
                    <div className="relative flex items-center">
                      <FileText className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18} />
                      <Input 
                        type="text" 
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Nom complet</label>
                    <div className="relative flex items-center">
                      <User className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18}/>
                      <Input 
                        type="text" 
                        placeholder="Gérant" 
                        className="pl-11"
                  ...
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Téléphone direct</label>
                    <div className="relative flex items-center">
                      <Phone className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18}/>
                      <Input 
                        type="text" 
                        ...
                        onChange={(e) => handleInputChange('telephoneResponsable', formatPhone(e.target.value))}
                        required 
                      />
                    </div>
                  ...
                  {/* CIN responsable */}
                  <div className="flex flex-col">
                    <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Numéro CIN</label>
                    <div className="relative flex items-center">
                      <CreditCard className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18}/>
                      <Input 
                        type="text" 
                        ...
                        onChange={(e) => handleInputChange('cinResponsable', formatCin(e.target.value))}
                        required 
                      />
                    </div>
                    {!isCinResponsableValid && (
                      <p className="text-red-500 text-[9px] font-semibold mt-1 ml-1 flex items-center gap-1 animate-in fade-in">
                        <AlertTriangle size={11} /> Requis : 12 chiffres (se terminant par 1 ou 2).
                      </p>
                    )}
                  </div>
          ...
          {!isEntreprise && (
            <div className="max-w-2xl mx-auto space-y-5 animate-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="flex flex-col">
                <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Nom et prénom(s)</label>
                <div className="relative flex items-center">
                  <User className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18}/>
                  <Input 
                    type="text" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col">
                  <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Numéro de téléphone</label>
                  <div className="relative flex items-center">
                    <Phone className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18}/>
                    <Input 
                      type="text" 
                      ...
                      onChange={(e) => handleInputChange('telephoneParticulier', formatPhone(e.target.value))}
                      required 
                    />
                  </div>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <Input 
                      ...
                      onChange={(e) => handleInputChange('cinParticulier', formatCin(e.target.value))}
                      required 
                    />
                  </div>
              ...
              <div className="flex flex-col">
                <label className="text-[11px] font-bold text-label ml-1 mb-1.5">Adresse postale / Localisation</label>
                <div className="relative flex items-center">
                  <MapPin className="absolute left-3.5 text-input-element/60 pointer-events-none" size={18}/>
                  <Input 
                    type="text" 
