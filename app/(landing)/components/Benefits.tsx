...
export default function Benefits() {
  return (
    <section
      id="solutions"
      className="w-full bg-background py-16 sm:py-20 md:py-24 font-sans select-none"
    >
      <div className="max-w-360 mx-auto px-4 sm:px-6 lg:px-16 space-y-20 sm:space-y-24 md:space-y-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 sm:gap-16 lg:gap-24">
          ...
          <div className="flex-1 w-full order-2 lg:order-1 group">
...
function BenefitItem({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="flex gap-3 sm:gap-4 items-start w-full">
      <div className="shrink-0 mt-0.5 sm:mt-1 flex items-center justify-center">
        {icon}
      </div>
