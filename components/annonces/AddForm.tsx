...
export default function AdForm({ mode, initialData, onCancel, onSave }: AdFormProps) {
  ...
  // États du formulaire
  const [productionType, setProductionType] = useState<ProductionType>("Végétale");
          ...
          {isLoading ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-center gap-4 pt-4 border-t border-slate-100">
                ...
                <Button
                  type="submit"
                  className="bg-primary hover:opacity-90 text-white font-bold h-11 px-8 rounded-xl shadow-sm gap-2 transition-all"
                >
