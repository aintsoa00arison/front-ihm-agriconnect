...
export default function AdForm({ mode, initialData, onCancel, onSave }: AdFormProps) {
  ...
  // État pour le chargement initial (skeleton)
  ...
  // Simulation du chargement initial de la page
  useEffect(() => {
    // Simule le chargement des données (appel API, etc.)
  ...
  // Fonction pour déclencher une notification popup (en bas à droite)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      // Déclenchement conditionnel du message selon le mode de saisie
      if (isEditMode) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <div className="h-11 bg-slate-200 rounded-xl w-24"></div>
            </div>
          </div>
          <div className="space-y-2">
            <div className="h-4 bg-slate-200 rounded w-32"></div>
